...
public class ReportManager {
	...
	private static Map<String, ITestResult> map = new HashMap<>();
	...
	public static ITestResult getTestResult(String name) {
		ITestResult res = map.get(name);
		return res;
	}
	...
	public static List<String> getOutput(String testName, String methodName) {
		ITestResult res = map.get(testName);
		if (res != null) {
