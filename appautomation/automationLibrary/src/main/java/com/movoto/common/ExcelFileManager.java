...
public class ExcelFileManager {
	...
	/**
	 * Description : Converts and returns string, formula, boolean and numeric cells as String
	 */
	...
	private void updateExcelSheet(int rowValue, int columnValue, String data) throws FileNotFoundException, IOException {
