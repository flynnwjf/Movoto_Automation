...
public class FC025Notification_Test_IOS extends BaseTest {
	...
	public void FC025notificationVerification(Map<String, Object> data) {
			scenarios.verifyforFC025notification(data);		
		}
